      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Logo - MIGRADO A OptimizedImage
            const Center(child: DistritoMallosLogo(height: 80)),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '• Ofrécenos os seus dados de contacto cando se rexistra para utilizar ou acceder a calquera sitio web, aplicación ou servizo que poñamos á súa disposición ou cando actualiza tales datos; e',
                    style: TextStyle(
                      fontSize: ResponsiveHelper.getCaptionFontSize(context),
                      height: 1.5,
                      color: Colors.black87,
                  ...
                  Text(
                    ...
                    '• ofrecer contido e servizos conxuntamente con terceiros cos que teña unha relación separada (por exemplo, provedores de redes socais); e\n'
